...
export class MenuService {
  private allItems: MenuItem[] = [
    ...
    { title: 'Alerts', url: '/admin/alerts', icon: 'warning-outline', roles: ['system_admin'] },
    { title: 'Alerts', url: '/employer/alerts', icon: 'warning-outline', roles: ['employer_hr'] },
    { title: 'Alerts', url: '/university/alerts', icon: 'warning-outline', roles: ['university_officer'] },
    { title: 'Alerts', url: '/clinic/alerts', icon: 'warning-outline', roles: ['clinic_admin'] },
    { title: 'Alerts', url: '/immigration/alerts', icon: 'warning-outline', roles: ['immigration_officer'] },
